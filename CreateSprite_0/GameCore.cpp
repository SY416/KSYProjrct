...
bool GameCore::CreateSampleState()
{
...
bool GameCore::GameInit()
{
    ...
    if (!m_DefaultPlane.Create(L"DefaultPlane", L"../../data/default.png"))
    {
        return false;
    }
...
bool GameCore::GameFrame()
{
    Frame();
    return true;
}

bool GameCore::GameRender()
{
