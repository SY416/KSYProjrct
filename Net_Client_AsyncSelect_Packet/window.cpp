#pragma once
#include "Net_Client_AsyncSelect_Packet.cpp"
#include "Protocol.h"
...
int APIENTRY wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow) {
	...
	g_hList = CreateWindow(L"listbox", NULL, style, 10, 10, 400, 500, g_hWnd, (HMENU)100, hInstance, NULL);
	g_hButton = CreateWindow(L"button", L"전송", style, 640, 10, 100, 100, g_hWnd, (HMENU)200, hInstance, NULL);
	style = WS_CHILD | WS_VISIBLE | ES_MULTILINE;
	g_hEdit = CreateWindow(L"edit", NULL, style, 430, 10, 200, 100, g_hWnd, (HMENU)300, hInstance, NULL);

	mainNet();
	SendMessage(g_hList, LB_ADDSTRING, 0, (LPARAM)L"채팅시작!!");
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow) {
	HWND hWnd = CreateWindowW(L"채팅 윈도우", L"채팅프로그램", WS_OVERLAPPEDWINDOW, 0, 0, 800, 600, nullptr, nullptr, hInstance, nullptr);
	if (!hWnd)
	{
		return FALSE;
	}
