...
bool CreateDevice::LoadTexture(std::wstring texFileName)
{
...
bool CreateDevice::Init()
{
    ...
    //m_VertexList.emplace_back(TVector3(0.33f, 0.5f, 0.5f), TVector4(0, 1, 0, 1), TVector2(0.0f, 0.0f));     // 0
    //m_VertexList.emplace_back(TVector3(0.5f, 0.5f, 0.5f), TVector4(0, 1, 0, 1), TVector2(0.0f, 0.0f));      // 1
    //m_VertexList.emplace_back(TVector3(0.5f, 0.33f, 0.5f), TVector4(0, 1, 0, 1), TVector2(0.0f, 0.0f));     // 2
    //m_VertexList.emplace_back(TVector3(0.33f, 0.33f, 0.5f), TVector4(0, 1, 0, 1), TVector2(0.0f, 0.0f));    // 3

    m_VertexList.emplace_back(TVector3(0.0f, 0.0f, 0.5f), TVector4(1, 1, 1, 1), TVector2(0.0f, 0.0f));      // 0
    m_VertexList.emplace_back(TVector3(m_rtClient.right, 0.0f, 0.5f), TVector4(1, 1, 1, 1), TVector2(1.0f, 0.0f));    // 1
    m_VertexList.emplace_back(TVector3(m_rtClient.right, m_rtClient.bottom, 0.5f), TVector4(1, 1, 1, 1), TVector2(1.0f, 1.0f));  // 2
    m_VertexList.emplace_back(TVector3(0.0f, m_rtClient.bottom, 0.5f), TVector4(1, 1, 1, 1), TVector2(0.0f, 1.0f));    // 3
